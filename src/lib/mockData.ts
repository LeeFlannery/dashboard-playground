...
export const mockSessionData: SessionData[] = Array.from({ length: 100 }, (_, i) => {
...
// Generate UserData
export const mockUserData: UserData[] = Array.from({ length: 50 }, (_, i) => {
...
export const mockConversionData: ConversionData[] = Array.from({ length: 200 }, (_, i) => {
...
// Calculate DashboardSummary from mock data
...
export const mockTimeSeriesData: ChartDataPoint[] = Array.from({ length: 30 }, (_, i) => {
  const date = new Date();
...
export const mockData = {
  ...
  users: mockUserData,
  conversions: mockConversionData,
